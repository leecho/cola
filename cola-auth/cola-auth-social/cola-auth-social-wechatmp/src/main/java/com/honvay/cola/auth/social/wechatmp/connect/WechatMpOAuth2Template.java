 ...
 */
@Slf4j
public class WechatMpOAuth2Template extends OAuth2Template {
	...
	private static final String REFRESH_TOKEN_URL = "https://connect.weixin.qq.com/sns/oauth2/refresh_token";

	public WechatMpOAuth2Template(String clientId, String clientSecret, String authorizeUrl, String accessTokenUrl) {
